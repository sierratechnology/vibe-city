...
- One Chrome/Metal browser rendered 50 moving server fixtures at 1440×900 on Apple M1. Initial sample 29 FPS; subsequent samples 44–54 FPS. A visual review found excessive nameplate overlap and prompted a bounded, collision-avoiding label pass. Final bounded-label run: samples ranged from 26–60 FPS, 689 draw calls, at most eight visible names. Concurrent local tests and Blender were running; this is not an isolated hardware benchmark.
